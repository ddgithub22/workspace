...
public class ProviderLevels {
	...
	private List<ClusterLevels> clustersList;
	...
	public List<ClusterLevels> getClustersList() {
		return clustersList;
	}
	public void setClustersList(List<ClusterLevels> clustersList) {
